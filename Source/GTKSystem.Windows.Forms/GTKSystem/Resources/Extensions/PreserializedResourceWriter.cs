...
public sealed class PreserializedResourceWriter : IResourceWriter, IDisposable
{
    ...
    private static readonly IReadOnlyDictionary<string, Type> s_primitiveTypes =
        new Dictionary<string, Type>(16, TypeNameComparer.Instance)
        {
            {
