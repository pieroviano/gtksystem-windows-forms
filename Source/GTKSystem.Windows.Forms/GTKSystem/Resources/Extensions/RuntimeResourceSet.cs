...
internal sealed class RuntimeResourceSet : ResourceSet, IEnumerable
{
    ...
    internal RuntimeResourceSet(IResourceReader reader)
    {
        ...
        _defaultReader = (reader as DeserializingResourceReader) ??
                         throw new ArgumentException(
                             SR.Format(SR.NotSupported_WrongResourceReader_Type, reader.GetType()), "reader");
            ...
            if (!_haveReadFromReader)
            {
                if (ignoreCase && _caseInsensitiveTable == null)
                {
                    _caseInsensitiveTable =
                        new Dictionary<string, ResourceLocator>(StringComparer.OrdinalIgnoreCase);
                }
                ...
                {
                    DeserializingResourceReader.ResourceEnumerator enumeratorInternal =
                        _defaultReader.GetEnumeratorInternal();
    ...
    private object ResolveResourceLocator(ResourceLocator resLocation, string key,
        Dictionary<string, ResourceLocator> copyOfCache, bool keyInWrongCase)
    {
