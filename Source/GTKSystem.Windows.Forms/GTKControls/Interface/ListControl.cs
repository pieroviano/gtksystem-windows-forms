...
public abstract class ListControl : ScrollableControl
{
    ...
    [DefaultValue("")] public virtual string DisplayMember { get; set; }
    ...
    [DefaultValue(false)] public virtual bool FormattingEnabled { get; set; }

    [DefaultValue("")] public virtual string ValueMember { get; set; }
