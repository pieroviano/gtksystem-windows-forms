...
{
    public readonly ButtonBase self;

    public override object GtkControl => self;

    public override string Text
    {
        get => ((Gtk.Label)self.Child).Text;
        set
        {
            ((Gtk.Label)self.Child).Text = value;
            base.Text = value;
        }
    }
    ...
    {
        get => self.Direction == Gtk.TextDirection.Rtl ? RightToLeft.Yes : RightToLeft.No;
