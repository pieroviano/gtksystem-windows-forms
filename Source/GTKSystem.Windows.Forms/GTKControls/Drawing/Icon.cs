...
public sealed class Icon : MarshalByRefObject, ICloneable, IDisposable, ISerializable
{
    ...
    public byte[] PixbufData
    {
        ...
        {
            _PixbufData = value;
            _Pixbuf = new Gdk.Pixbuf((byte[])value.Clone());
        }
    }
    ...
    public Gdk.Pixbuf Pixbuf
    {
        get
        {
            ...
            {
                _Pixbuf = new Gdk.Pixbuf((byte[])_PixbufData.Clone());
            }
    ...
    [Browsable(false)] public IntPtr Handle { get; private set; }
    ...
    public object Clone()
    {
        return new Icon(this.FileName, this.Width, this.Height)
            { Pixbuf = this.Pixbuf, PixbufData = (byte[])this.PixbufData.Clone() };
    }
    ...
    public Bitmap ToBitmap()
    {
        return new Bitmap(this.Width, this.Height)
            { PixbufData = this.PixbufData, Pixbuf = this.Pixbuf, FileName = this.FileName };
    }
