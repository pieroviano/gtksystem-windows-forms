...
public sealed class Font : MarshalByRefObject, ICloneable, IDisposable, ISerializable
{
    ...
    /// operator.
    /// </param>
    public Font(Font? prototype, FontStyle newStyle) : this(prototype?.FontFamily, prototype?.Size ?? default, newStyle, prototype?.Unit ?? default,
        prototype?.GdiCharSet ?? default, prototype?.GdiVerticalFont ?? default)
    {
    ...
    /// </summary>
    /// <param name="family">The System.Drawing.FontFamily of the new System.Drawing.Font.</param>
    ...
    /// <param name="style">The System.Drawing.FontStyle of the new font.</param>
    /// <param name="unit">The System.Drawing.GraphicsUnit of the new font.</param>
    /// <param name="gdiCharSet">A System.Byte that specifies a GDI character set to use for the new font.</param>
    /// <exception cref="System.ArgumentException">
    /// emSize is less than or equal to 0, evaluates to infinity, or is not a valid number.
    /// </exception>
    /// <exception cref="System.ArgumentNullException">
    ...
    /// <param name="style">The System.Drawing.FontStyle of the new font.</param>
    /// <param name="unit">The System.Drawing.GraphicsUnit of the new font.</param>
    /// <param name="gdiCharSet">A System.Byte that specifies a GDI character set to use for this font.</param>
    /// <exception cref="System.ArgumentException">
    /// emSize is less than or equal to 0, evaluates to infinity, or is not a valid number.
    /// </exception>
    ...
    [Browsable(false)] public int Height { get; } = 0;
    ...
    /// </returns>
    [Browsable(false)] public bool IsSystemFont { get; } = default;
    ...
    /// </returns>
    [Browsable(false)]
    public string? SystemFontName { get; } = default;

    /// <summary>
    /// Gets the em-size of this System.Drawing.Font measured in the units specified
    /// by the System.Drawing.Font.Unit property.
    /// </summary>
    /// <returns>The em-size of this System.Drawing.Font.</returns>
    public float Size { get; }

    /// <summary>
    /// Gets the em-size, in points, of this System.Drawing.Font.
    /// </summary>
    /// <returns>The em-size, in points, of this System.Drawing.Font.</returns>
    [Browsable(false)]
    public float SizeInPoints { get; } = default;
    ...
    /// </returns>
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public bool Strikeout { get; } = default;
    ...
    /// </returns>
    [Browsable(false)]
    public string? OriginalFontName { get; } = default;
    /// <summary>
    ...
    /// <returns>The System.Drawing.Font this method creates.</returns>
    /// <exception cref="System.ArgumentException">The font for the specified device context is not a TrueType font.</exception>
    ...
    /// <returns>The System.Drawing.Font this method creates.</returns>
    /// <exception cref="System.ArgumentException">hfont points to an object that is not a TrueType font.</exception>
    ...
    /// /// <exception cref="System.ArgumentException">The font is not a TrueType font.</exception>
    ...
    /// </summary>
    /// <returns>The System.Drawing.Font this method creates, cast as an System.Object.</returns>
    ...
    /// </summary>
    /// <returns>The hash code for this System.Drawing.Font.</returns>
    ...
    /// font.
    /// </param>
    /// <returns>The height, in pixels, of this System.Drawing.Font.</returns>
    ...
    /// </summary>
    /// <param name="logFont">A System.Object to represent the LOGFONT structure that this method creates.</param>
    /// <param name="graphics">
    ...
    /// Creates a GDI logical font (LOGFONT) structure from this System.Drawing.Font.
    /// </summary>
    /// <param name="logFont">An System.Object to represent the LOGFONT structure that this method creates.</param>
