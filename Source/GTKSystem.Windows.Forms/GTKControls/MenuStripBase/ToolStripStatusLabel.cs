...
public class ToolStripStatusLabel : ToolStripLabel
{
    ...
    public ToolStripStatusLabel(string text, Image image, EventHandler onClick, string name) : base(text, image,
        onClick, name)
    {
    }

    [DefaultValue(Border3DStyle.Flat)] public Border3DStyle BorderStyle { get; set; }
    ...
    [DefaultValue(false)] public bool Spring { get; set; }
}