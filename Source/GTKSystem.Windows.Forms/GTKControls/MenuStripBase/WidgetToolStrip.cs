...
public class WidgetToolStrip<T> : ToolStripItem, IDropTarget, ISupportOleDropSource, IArrangedElement, IComponent,
    IDisposable, IKeyboardToolTip
{
    public override string unique_key { get; protected set; }

    public override Gtk.MenuItem MenuItem
    {
        get => base.MenuItem;
        set { base.MenuItem = value; }
    }
    ...
    public WidgetToolStrip(string text, System.Drawing.Image image, EventHandler onClick) : this(null, text, image,
        onClick, "")
    {
    }

    public WidgetToolStrip(string text, System.Drawing.Image image, EventHandler onClick, string name) : this(null,
        text, image, onClick, "")
    {
    }

    protected WidgetToolStrip(string stripType, string text, System.Drawing.Image image, EventHandler onClick,
        string name, params object[] args) : base(text, image, onClick, name)
    {
    ...
    {
        get => MenuItem.Halign == Gtk.Align.End ? ToolStripItemAlignment.Right : ToolStripItemAlignment.Left;
        set
        {
            MenuItem.Hexpand = true;
            MenuItem.Halign = Gtk.Align.End;
    ...
    private void ToolStripItem_Realized(object sender, EventArgs e)
    {
        ...
        else if (this.CheckState == CheckState.Indeterminate)
        {
            Gtk.RadioButton checkbutton =
                new Gtk.RadioButton(((WidgetToolStrip<Gtk.MenuItem>)this.Parent).groupradio);
            checkbutton.StyleContext.AddClass("MenuCheck");
            checkbutton.BorderWidth = 0;
            checkbutton.Margin = 0;
            checkbutton.Halign = Gtk.Align.Center;
            ...
            try
            {
                ...
                else if (DisplayStyle == ToolStripItemDisplayStyle.Image)
                {
                    ...
                    if (Image != null && Image.PixbufData != null)
                    {
                        Gtk.Image ico1 =
                            new Gtk.Image(
                                new Gdk.Pixbuf(Image.PixbufData).ScaleSimple(20, 20, Gdk.InterpType.Tiles));
    ...
    protected virtual void SetStyle(Gtk.Widget widget)
    {
        ...
        css.AppendLine(
            " menu menuitem .MenuCheck{padding:0px;margin:0px;} menu .MenuItem{padding:0px;margin-left:-23px;}");
    ...
    {
        get { return this.Widget.TooltipText; }
        set { this.Widget.TooltipText = value; }
    }
    ...
    {
        get { return this.Widget.HeightRequest; }
        set { this.Widget.HeightRequest = value; }
    }
    ...
    {
        get { return new Size(this.Widget.WidthRequest, this.Widget.HeightRequest); }
    ...
    {
        get { return this.Widget.WidthRequest; }
        set { this.Widget.WidthRequest = value; }
    }
