...
public abstract class ToolStripDropDownItem : WidgetToolStrip<Gtk.MenuItem>
{
    ...
    protected ToolStripDropDownItem(string text, Image image, params ToolStripItem[] dropDownItems) : this(text,
        image, null, "")
    {
        DropDownItems.AddRange(dropDownItems);
    }

    protected ToolStripDropDownItem(string text, Image image, EventHandler onClick, string name) : base(
        "ToolStripDropDownItem", text, image, onClick, name)
    {
    ...
    [Browsable(false)] public bool HasDropDown { get; }

    [Browsable(false)] public virtual bool HasDropDownItems { get; }

    //public ToolStripItemCollection DropDownItems { get; }

    [Browsable(false)] public ToolStripDropDownDirection DropDownDirection { get; set; }
