...
{
    public readonly TreeViewBase self;
    ...
    private class CellRendererIcon : CellRendererPixbuf
    {
        ...
        public int PixbufIndex
        {
            set
            {
                ...
                {
                    var imageListImage = _treeView.ImageList.Images[value];
                    if (imageListImage != null)
                    {
                        Pixbuf = imageListImage.Pixbuf;
                    }
                }
            }
        }
        ...
        public string PixbufKey
        {
            set
            {
                if (string.IsNullOrWhiteSpace(value) == false && (_treeView.ImageList?.Images.ContainsKey(value)??false))
                {
                    var imageListImage = _treeView.ImageList.Images[value];
                    if (imageListImage != null)
                    {
