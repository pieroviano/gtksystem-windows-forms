...
public sealed class GtkControlOverride : IControlOverride
{
    ...
    public void OnDrawnBackground(Cairo.Context cr, Gdk.Rectangle area)
    {
        ...
        {
            if (backgroundPixbuf == null || backgroundPixbuf.Width != area.Width ||
                backgroundPixbuf.Height != area.Height)
            {
                ImageUtility.ScaleImageByImageLayout(BackgroundImage.PixbufData, area.Width, area.Height,
                    out backgroundPixbuf, BackgroundImageLayout);
            }
    ...
    public void OnPaint(Cairo.Context cr, Gdk.Rectangle area)
    {
        ...
        if (Paint != null)
            Paint(this.container,
                new PaintEventArgs(new Graphics(container, cr, area),
