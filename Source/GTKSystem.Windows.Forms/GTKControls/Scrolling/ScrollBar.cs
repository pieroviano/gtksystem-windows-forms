...
public abstract partial class ScrollBar : Control
{
    ...
    private void Control_ValueChanged(object sender, EventArgs e)
    {
        ...
        var args = new ScrollEventArgs(
            newValue >= _oldValue ? ScrollEventType.SmallIncrement : ScrollEventType.SmallDecrement, (int)_oldValue,
            (int)newValue);
    ...
    {
        get => (int)Adjustment.StepIncrement;
        set => Adjustment.StepIncrement = value;
    }

    public int LargeChange
    {
        get => (int)Adjustment.PageIncrement;
        set => Adjustment.PageIncrement = value;
    }

    public int Maximum
    {
        get => (int)Adjustment.Upper;
        set => Adjustment.Upper = value;
    }

    public int Minimum
    {
        get => (int)Adjustment.Lower;
