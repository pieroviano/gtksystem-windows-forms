...
public class DataGridViewTextBoxColumn : DataGridViewColumn
{
    ...
    public DataGridViewTextBoxColumn(DataGridView owningDataGridView) : base(owningDataGridView,
...
public class DataGridViewCheckBoxColumn : DataGridViewColumn
{
    ...
    public DataGridViewCheckBoxColumn(DataGridView owningDataGridView) : base(owningDataGridView,
...
public class DataGridViewRadioColumn : DataGridViewColumn
{
    ...
    public DataGridViewRadioColumn(DataGridView owningDataGridView) : base(owningDataGridView,
        new DataGridViewCheckBoxCell())
    {
        ValueType = typeof(bool);
        this.SortMode = DataGridViewColumnSortMode.NotSortable;
...
public class DataGridViewComboBoxColumn : DataGridViewColumn
{
    ...
    public DataGridViewComboBoxColumn(DataGridView owningDataGridView) : base(owningDataGridView,
...
public class DataGridViewButtonColumn : DataGridViewColumn
{
    ...
    public DataGridViewButtonColumn(DataGridView owningDataGridView) : base(owningDataGridView,
    ...
    public override void Renderer()
    {
        ...
        else if (base.DefaultCellStyle.Alignment == null ||
                 base.DefaultCellStyle.Alignment == DataGridViewContentAlignment.NotSet)
        {
    ...
    private void TreeView_RowActivated(object o, RowActivatedArgs args)
    {
        if (args.Column.Handle == this.Handle)
        {
            if (args.Column.Cells[0] is CellRendererText cell)
            {
                ...
                _gridview.CellValueChanagedHandler(this.DisplayIndex, path.Indices.Last(),
                    new CellValue() { Value = cell.Text });
            }
        }
    }
}
...
public class DataGridViewImageColumn : DataGridViewColumn
{
    ...
    public DataGridViewImageColumn(DataGridView owningDataGridView) : base(owningDataGridView,
...
public class DataGridViewLinkColumn : DataGridViewColumn
{
    ...
    public DataGridViewLinkColumn(DataGridView owningDataGridView) : base(owningDataGridView,
...
public class DataGridViewColumn : TreeViewColumn
{
    ...
    public DataGridViewColumn(DataGridView owningDataGridView, DataGridViewCell cellTemplate) : this(0,
        owningDataGridView, cellTemplate)
    {
    }
    ...
    public virtual void Renderer()
    {
        ...
        if (_gridview != null)
        {
            ...
            if (_gridview.AutoSizeRowsMode == DataGridViewAutoSizeRowsMode.AllCells ||
                _gridview.AutoSizeRowsMode == DataGridViewAutoSizeRowsMode.DisplayedCells ||
                _gridview.RowTemplate.Resizable == DataGridViewTriState.True)
            {
            }
            else
            {
    ...
    [Browsable(false)] public int DisplayIndex { get; set; }

    [Localizable(true)]
    [RefreshProperties(RefreshProperties.Repaint)]
    public new int Width
    {
        get { return base.FixedWidth; }
        set { base.FixedWidth = value; }
    }
    ...
    [DefaultValue("")] [Localizable(true)] public string ToolTipText { get; set; }
    ...
    [Browsable(false)] public DataGridViewCellStyle InheritedStyle { get; }
    ...
    [DefaultValue(100)] public float FillWeight { get; set; }
    [DefaultValue(0)] public int DividerWidth { get; set; }

    [Browsable(true)] public DataGridViewCellStyle DefaultCellStyle { get; set; }
    [Browsable(true)] [DefaultValue("")] public string DataPropertyName { get; set; }
    [DefaultValue(null)] public ContextMenuStrip ContextMenuStrip { get; set; }

    [Browsable(false)]
    [EditorBrowsable(EditorBrowsableState.Advanced)]
    public virtual Type CellType
    {
        get { return _cellTemplate.GetType(); }
    }
