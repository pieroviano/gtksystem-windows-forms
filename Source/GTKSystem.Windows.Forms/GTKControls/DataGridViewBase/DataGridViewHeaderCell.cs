...
public class DataGridViewHeaderCell : DataGridViewCell
{
    ...
    [Browsable(false)] public override bool Displayed { get; }

    internal Bitmap FlipXPThemesBitmap { get; set; }

    public override Type FormattedValueType { get; }

    [Browsable(false)] public override bool Frozen { get; }

    [Browsable(false)]
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    public override bool ReadOnly { get; set; }

    [Browsable(false)] public override bool Resizable { get; }
