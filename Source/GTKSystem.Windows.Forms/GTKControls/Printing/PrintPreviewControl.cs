...
{
    public readonly ViewportBase self;
    ...
    {
        if (AutoZoom == false && paper != null && _document != null)
        {
            paper.WidthRequest =
                (int)Math.Round(_document.PageSetup.GetPaperWidth(Unit.Points) * _zoom / 0.75, 0);
            paper.HeightRequest =
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public override void ResetBackColor() => BackColor = Color.FromArgb(
