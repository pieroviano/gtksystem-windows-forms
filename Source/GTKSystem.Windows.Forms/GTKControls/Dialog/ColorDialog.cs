...
public class ColorDialog : CommonDialog
{
    ...
    [DefaultValue(false)] public virtual bool AnyColor { get; set; }
    ...
    [DefaultValue(false)] public virtual bool SolidColorOnly { get; set; }
    ...
    protected override bool RunDialog(IWin32Window owner)
    {
        ...
        if (Color.Name != "0")
            colorChooserDialog.Rgba = new Gdk.RGBA()
            {
                Alpha = (double)Color.A / 255, Red = (double)Color.R / 255, Green = (double)Color.G / 255,
        ...
        this.Color = Color.FromArgb((int)(colorSelection.Alpha * 255), (int)Math.Round(colorSelection.Red * 255, 0),
            (int)Math.Round(colorSelection.Green * 255, 0), (int)Math.Round(colorSelection.Blue * 255, 0));
        return res == -5;
    }
