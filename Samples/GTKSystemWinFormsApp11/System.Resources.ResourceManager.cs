...
public class ResourceManager : Windows.Forms.Resources.ResourceManager
{
    ...
    public ResourceManager(string? baseName, Assembly? assembly, System.Type resourceSource) : base(baseName,
        assembly, resourceSource)
    {
