...
public class ControlPropertyEventsTest : TestHelper
{
    ...
    public void PropertyLeft()
    {
        ...
        Assert.True(ew.ToString().Contains("Move;LocationChanged;DockChanged"), "B2");

        ew.Clear();
        c.Left = 27;
        Assert.AreNotEqual(string.Empty, ew.ToString(), "B3");
    }
    ...
    public void PropertyLocation()
    {
        ...
        Assert.True(ew.ToString().Contains("Move;LocationChanged"), "B2");
    ...
    public void PropertyMargin()
    {
        ...
        Assert.True(new Padding(5)== c.Margin, "B1");
        Assert.True(ew.ToString().Contains("MarginChanged"), "B2");
